...
?>
	...
	<div class="post">
		<h2 class="title"><a href="#">New Artikel </a></h2>
		...
		if (isset($_POST['isi']))//periksa apakah user telah menekan submit, dengan menggunakan parameter setingan isi
		{
			...
			{
				?><script> document.location.href='home.php?page=edit-artikel-new&status=Data Anda belum lengkap.';</script>";<?php
			}
			else
			{
				...
				if (move_uploaded_file($_FILES['fotodoc']['tmp_name'],$alamatgambar))//periksa jika proses upload berjalan sukses
				{
					...
					?><script> document.location.href='home.php?page=edit-artikel&status=Data Anda berhasil di simpan.'; </script>";<?php
		...
		<tr>
		  ...
		  <input type="hidden" name="penulis" value="<?php echo $userid;?>" /></td>
			<td width="71%"><font face="verdana" size="2" color="#666666"><?php echo ucwords($userid);?></font></td>
		</tr>
		<tr>
